...
export function generateMarkdown(data: NdaFormData): string {
  ...
  lines.push("|---|---|---|");
  lines.push(`| Print Name | ${fallback(p1.name, "")} | ${fallback(p2.name, "")} |`);
  lines.push(`| Title | ${fallback(p1.title, "")} | ${fallback(p2.title, "")} |`);
  lines.push(`| Company | ${fallback(p1.company, "")} | ${fallback(p2.company, "")} |`);
  lines.push(`| Notice Address | ${fallback(p1.noticeAddress, "")} | ${fallback(p2.noticeAddress, "")} |`);
